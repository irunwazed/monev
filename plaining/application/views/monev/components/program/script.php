<script>
    ...
    function setTable(data){
        ...
        data.forEach(element => {
            let myCodeLink = element['tb_rpjmd_misi_kode']+"-"+element['tb_rpjmd_tujuan_kode']+"-"+element['tb_rpjmd_sasaran_kode']+"-"+element['tb_rpjmd_program_kode'];
            let myCode = myCodeLink.replace(/-/g, '.');
            tempData = [
                no,
                myCode,
                '<a href="'+base_url+'monev/kegiatan/'+myCodeLink+'">'+element['tb_rpjmd_program_nama']+'</a>',
                element['tb_rpjmd_program_pagu_ket'],
