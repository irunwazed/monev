...
class DataRpjmdController extends CI_Controller {
    ...
    public function view($tahun = null){
        ...
        $post = array();
        $foot = array();
        $foot['script'] = $this->load->view('monev/components/rpjmd/script', $data, true);
        $this->load->view('monev/include/head');
        $this->load->view('monev/components/rpjmd/data', $data);
