<script>
    ...
    function setTable(data){
        ...
        data.forEach(element => {
            let myCodeLink = element['tb_rpjmd_misi_kode']+"-"+element['tb_rpjmd_tujuan_kode'];
            let myCode = myCodeLink.replace(/-/g, '.');
            tempData = [
                no,
                myCode,
                '<a href="'+base_url+'monev/sasaran/'+myCodeLink+'">'+element['tb_rpjmd_tujuan_nama']+'</a>',
